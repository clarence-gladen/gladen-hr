const en = {
  ...
  dashboard: {
    ...
    checkOutToEnd: "Check out to end your shift",
  ...
  more: {
    managerTitle: "More",
    groupSiteOps: "Site operations",
    groupPeoplePay: "People & pay",
    groupSettings: "Settings",
    attendance: "Attendance",
    checklists: "Cleaning checklists",
    reports: "Service reports",
    contractsShort: "Contracts",
    ratesShort: "Statutory rates",
    contractsDesc: "Sites and profitability",
    attendanceDesc: "Check-in log",
    attendanceOnSite: "{n} on site now",
    checklistsDesc: "Tasks by area",
    reportsDesc: "Monthly PDF",
    announcementsDesc: "Post to staff",
    salaryAdvancesDesc: "Advances and repayments",
    salaryAdvancesPending: "{n} pending",
    overtimeDesc: "Hours and rates",
    supervisorsDesc: "Site leads",
    ratesDesc: "CPF \u00b7 FWL \u00b7 SDL",
    manageAccessDesc: "Manager logins",
